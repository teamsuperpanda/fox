...
abstract class AppLocalizations {
  ...
  /// No description provided for @screenshotLightTagline.
  ///
  /// In en, this message translates to:
  /// **'Your notes, your way'**
  String get screenshotLightTagline;

  /// No description provided for @screenshotLightMarketing1.
  ///
  /// In en, this message translates to:
  /// **'Organise thoughts with rich text'**
  String get screenshotLightMarketing1;

  /// No description provided for @screenshotLightMarketing2.
  ///
  /// In en, this message translates to:
  /// **'Fast, private, offline-first'**
  String get screenshotLightMarketing2;

  /// No description provided for @screenshotDarkTagline.
  ///
  /// In en, this message translates to:
  /// **'Beautiful in light or dark'**
  String get screenshotDarkTagline;

  /// No description provided for @screenshotDarkMarketing1.
  ///
  /// In en, this message translates to:
  /// **'Full dark mode support'**
  String get screenshotDarkMarketing1;

  /// No description provided for @screenshotDarkMarketing2.
  ///
  /// In en, this message translates to:
  /// **'Easy on the eyes, always'**
  String get screenshotDarkMarketing2;

  /// No description provided for @screenshotNewNoteTagline.
  ///
  /// In en, this message translates to:
  /// **'Capture ideas instantly'**
  String get screenshotNewNoteTagline;

  /// No description provided for @screenshotNewNoteMarketing1.
  ///
  /// In en, this message translates to:
  /// **'Rich text  •  Checklists  •  Colours'**
  String get screenshotNewNoteMarketing1;

  /// No description provided for @screenshotNewNoteMarketing2.
  ///
  /// In en, this message translates to:
  /// **'Everything you need'**
  String get screenshotNewNoteMarketing2;

  /// No description provided for @screenshotSettingsTagline.
  ///
  /// In en, this message translates to:
  /// **'Customise the app your way'**
  String get screenshotSettingsTagline;

  /// No description provided for @screenshotSettingsMarketing1.
  ///
  /// In en, this message translates to:
  /// **'Accent colors  •  Sort options  •  Language'**
  String get screenshotSettingsMarketing1;

  /// No description provided for @screenshotSettingsMarketing2.
  ///
  /// In en, this message translates to:
  /// **'Make it truly yours'**
  String get screenshotSettingsMarketing2;
}
